...
describe('frigateEventUrl', () => {
  it('builds correct URL using /review?id= format (Frigate 0.14+)', () => {
    expect(frigateEventUrl('http://192.168.1.10:5000', 'abc-123')).toBe(
      'http://192.168.1.10:5000/review?id=abc-123'
    )
  })
